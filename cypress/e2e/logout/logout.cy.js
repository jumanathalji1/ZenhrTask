...
Given('Visit ZenHR website', function(){
  ...
  Then('Click on right side menu', function(){
    commonActions.clickRightSideMenu()
  })


  Then('Click on logout', function(){
    commonActions.clickLogoutButton()
  })

  Then('Assert logout', function(){
    commonActions.assertLogout()
  })